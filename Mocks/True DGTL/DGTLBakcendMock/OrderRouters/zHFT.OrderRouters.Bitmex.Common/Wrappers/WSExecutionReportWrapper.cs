...
{
    public class WSExecutionReportWrapper : BaseExecutionReportWrapper
    {
        #region Constructors

        public WSExecutionReportWrapper(ExecutionReport pExecutionReport, zHFT.OrderRouters.Bitmex.BusinessEntities.Order pOrder)
        {
